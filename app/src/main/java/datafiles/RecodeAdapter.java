...
public class RecodeAdapter extends StatelessSection {

    private String UserID;
    Context context;
    private Activity activity;
    private Reuseable reuseable;
    private List<DatabaseReference> Refs;
    ...
    public RecodeAdapter(List<DatabaseReference> Refs, Context context, Activity activity, String userID) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder nholder, int position) {
        ...
        CardView crdBody = holder.crdBody;
        ...
        final char[] uName = new char[1];

        final DatabaseReference postRef = Refs.get(position);
        postRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists()){
                    ...
                    crdBody.setVisibility(View.GONE);
                    return;
                }
                ChatMessage model = dataSnapshot.getValue(ChatMessage.class);
                uName[0] = model.getMessageUserId().charAt(0);
                ...
                if((!model.getMessageUserId().equals(UserID))
                    ...
                    reuseable.setTextColor(context, messageUser, uName[0]);
                }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public ItemViewHolder(View v) {
            super(v);
            crdBody = v.findViewById(R.id.crdBody);
